...
const ShowDetail = () => {
  const { product, images, isAdmin } = usePage().props
  ...
  return (
    <div className='flex flex-col gap-1'>
      <div className='flex flex-wrap gap-4'>
        <ShowThumbnail product={product} images={images} deleteButton={isAdmin} />
...
export const ShowThumbnail = ({ product, images, deleteButton = false, isFull = false }) => {
