...
const LessonDeleteModal = (state) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    destroy(`${page.url}/${data.module_id}/lessons/${id}?ref=${location}`, {
      onSuccess: () => {
  ...
  return (
    <WithModal type={MODAL_TYPE} backdrop={true} onClick={handleClick}>
      <form action=''>
        ...
        <p>Apakah anda yakin ingin menghapus Materi Pelajaran ini?</p>
